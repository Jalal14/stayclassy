        ...
        <div class="card">
            <form method="post" id="promotion" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="image1" class="col-sm-3 col-form-label">Left image: </label>
                        <div class="col-sm-9">
                            <input type="file" id="image-upoad-1" class="form-control" name="image1" accept='image/*'>
                            <img class="uploaded-image img-thumbnail img-responsive" id="img-1"  src="{{asset('images')}}/{{$layout->left_image}}">
                        </div>
                    </div>
                    <div class="error">
                        @if(session('msg'))
